...
GREETING_RESPONSES = ["hi", "hey", "hii there", "hi there", "hello", "I am glad! You are talking to me","Water conservation"]
Basic_Q = ("what is python ?","what is python","what is python?","what is python." "Water co")
